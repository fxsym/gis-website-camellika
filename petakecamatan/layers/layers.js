...
var format_balai_desa_20 = new ol.format.GeoJSON();
var features_balai_desa_20 = format_balai_desa_20.readFeatures(json_balai_desa_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_balai_desa_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_balai_desa_20.addFeatures(features_balai_desa_20);
var lyr_balai_desa_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_balai_desa_20, 
                style: style_balai_desa_20,
                popuplayertitle: 'balai_desa',
                interactive: true,
                title: '<img src="styles/legend/balai_desa_20.png" /> balai_desa'
            });
var format_kantor_kecamatan_21 = new ol.format.GeoJSON();
var features_kantor_kecamatan_21 = format_kantor_kecamatan_21.readFeatures(json_kantor_kecamatan_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_kantor_kecamatan_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_kantor_kecamatan_21.addFeatures(features_kantor_kecamatan_21);
var lyr_kantor_kecamatan_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_kantor_kecamatan_21, 
                style: style_kantor_kecamatan_21,
                popuplayertitle: 'kantor_kecamatan',
                interactive: true,
                title: '<img src="styles/legend/kantor_kecamatan_21.png" /> kantor_kecamatan'
            });
var format_pendidikan_22 = new ol.format.GeoJSON();
var features_pendidikan_22 = format_pendidikan_22.readFeatures(json_pendidikan_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pendidikan_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_pendidikan_22.addFeatures(features_pendidikan_22);
var lyr_pendidikan_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_pendidikan_22, 
                style: style_pendidikan_22,
                popuplayertitle: 'pendidikan',
                interactive: true,
                title: '<img src="styles/legend/pendidikan_22.png" /> pendidikan'
            });
var format_kesehatan_23 = new ol.format.GeoJSON();
var features_kesehatan_23 = format_kesehatan_23.readFeatures(json_kesehatan_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_kesehatan_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_kesehatan_23.addFeatures(features_kesehatan_23);
var lyr_kesehatan_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_kesehatan_23, 
                style: style_kesehatan_23,
                popuplayertitle: 'kesehatan',
                interactive: true,
                title: '<img src="styles/legend/kesehatan_23.png" /> kesehatan'
            });
var format_wisata_24 = new ol.format.GeoJSON();
var features_wisata_24 = format_wisata_24.readFeatures(json_wisata_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_wisata_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_wisata_24.addFeatures(features_wisata_24);
var lyr_wisata_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_wisata_24, 
                style: style_wisata_24,
                popuplayertitle: 'wisata',
                interactive: true,
                title: '<img src="styles/legend/wisata_24.png" /> wisata'
            });
var format_tempat_ibadah_25 = new ol.format.GeoJSON();
var features_tempat_ibadah_25 = format_tempat_ibadah_25.readFeatures(json_tempat_ibadah_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_tempat_ibadah_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tempat_ibadah_25.addFeatures(features_tempat_ibadah_25);
var lyr_tempat_ibadah_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tempat_ibadah_25, 
                style: style_tempat_ibadah_25,
                popuplayertitle: 'tempat_ibadah',
                interactive: true,
                title: '<img src="styles/legend/tempat_ibadah_25.png" /> tempat_ibadah'
            });
var format_Kuburan_26 = new ol.format.GeoJSON();
var features_Kuburan_26 = format_Kuburan_26.readFeatures(json_Kuburan_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Kuburan_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Kuburan_26.addFeatures(features_Kuburan_26);
var lyr_Kuburan_26 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Kuburan_26, 
                style: style_Kuburan_26,
                popuplayertitle: 'Kuburan',
                interactive: true,
                title: '<img src="styles/legend/Kuburan_26.png" /> Kuburan'
            });
var format_Lapangan_27 = new ol.format.GeoJSON();
var features_Lapangan_27 = format_Lapangan_27.readFeatures(json_Lapangan_27, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Lapangan_27 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lapangan_27.addFeatures(features_Lapangan_27);
var lyr_Lapangan_27 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lapangan_27, 
                style: style_Lapangan_27,
                popuplayertitle: 'Lapangan',
                interactive: true,
                title: '<img src="styles/legend/Lapangan_27.png" /> Lapangan'
            });
var format_Toko_28 = new ol.format.GeoJSON();
var features_Toko_28 = format_Toko_28.readFeatures(json_Toko_28, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Toko_28 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Toko_28.addFeatures(features_Toko_28);
var lyr_Toko_28 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Toko_28, 
                style: style_Toko_28,
                popuplayertitle: 'Toko',
                interactive: true,
                title: '<img src="styles/legend/Toko_28.png" /> Toko'
            });
var format_Tempatmakan_29 = new ol.format.GeoJSON();
var features_Tempatmakan_29 = format_Tempatmakan_29.readFeatures(json_Tempatmakan_29, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Tempatmakan_29 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Tempatmakan_29.addFeatures(features_Tempatmakan_29);
var lyr_Tempatmakan_29 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Tempatmakan_29, 
                style: style_Tempatmakan_29,
                popuplayertitle: 'Tempat makan',
                interactive: true,
                title: '<img src="styles/legend/Tempatmakan_29.png" /> Tempat makan'
            });
var format_Rumah_saya_30 = new ol.format.GeoJSON();
var features_Rumah_saya_30 = format_Rumah_saya_30.readFeatures(json_Rumah_saya_30, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rumah_saya_30 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rumah_saya_30.addFeatures(features_Rumah_saya_30);
var lyr_Rumah_saya_30 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rumah_saya_30, 
                style: style_Rumah_saya_30,
                popuplayertitle: 'Rumah_saya',
                interactive: true,
                title: '<img src="styles/legend/Rumah_saya_30.png" /> Rumah_saya'
            });
var group_point = new ol.layer.Group({
                                layers: [lyr_balai_desa_20,lyr_kantor_kecamatan_21,lyr_pendidikan_22,lyr_kesehatan_23,lyr_wisata_24,lyr_tempat_ibadah_25,lyr_Kuburan_26,lyr_Lapangan_27,lyr_Toko_28,lyr_Tempatmakan_29,lyr_Rumah_saya_30,],
                                fold: 'open',
                                title: 'point'});
...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_batas_kecamatan_1.setVisible(true);lyr_batas_desa_2.setVisible(true);lyr_perkebunan_fix_3.setVisible(true);lyr_sawah_fix_4.setVisible(true);lyr_ladang_fix_5.setVisible(true);lyr_hutan_fix_6.setVisible(true);lyr_desa_parungkamal_7.setVisible(true);lyr_desa_karanggayam_8.setVisible(true);lyr_desa_lumbir_9.setVisible(true);lyr_desa_kedunggede_10.setVisible(true);lyr_desa_dermaji_11.setVisible(true);lyr_desa_cirahab_12.setVisible(true);lyr_desa_cingebul_13.setVisible(true);lyr_desa_cidora_14.setVisible(true);lyr_desa_canduk_15.setVisible(true);lyr_desa_besuki_16.setVisible(true);lyr_bangunan_17.setVisible(true);lyr_jalan_fix_18.setVisible(true);lyr_sungai_fix_19.setVisible(true);lyr_balai_desa_20.setVisible(true);lyr_kantor_kecamatan_21.setVisible(true);lyr_pendidikan_22.setVisible(true);lyr_kesehatan_23.setVisible(true);lyr_wisata_24.setVisible(true);lyr_tempat_ibadah_25.setVisible(true);lyr_Kuburan_26.setVisible(true);lyr_Lapangan_27.setVisible(true);lyr_Toko_28.setVisible(true);lyr_Tempatmakan_29.setVisible(true);lyr_Rumah_saya_30.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_batas_kecamatan_1,lyr_batas_desa_2,group_polygon,lyr_jalan_fix_18,lyr_sungai_fix_19,group_point];
lyr_batas_kecamatan_1.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'METADATA': 'METADATA', 'SRS_ID': 'SRS_ID', 'KDBBPS': 'KDBBPS', 'KDCBPS': 'KDCBPS', 'KDCPUM': 'KDCPUM', 'KDEBPS': 'KDEBPS', 'KDEPUM': 'KDEPUM', 'KDPBPS': 'KDPBPS', 'KDPKAB': 'KDPKAB', 'KDPPUM': 'KDPPUM', 'LUASWH': 'LUASWH', 'TIPADM': 'TIPADM', 'WADMKC': 'WADMKC', 'WADMKD': 'WADMKD', 'WADMKK': 'WADMKK', 'WADMPR': 'WADMPR', 'WIADKC': 'WIADKC', 'WIADKK': 'WIADKK', 'WIADPR': 'WIADPR', 'WIADKD': 'WIADKD', 'UUPP': 'UUPP', 'luas': 'luas', 'SHAPE_Leng': 'SHAPE_Leng', 'SHAPE_Area': 'SHAPE_Area', });
lyr_batas_desa_2.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'METADATA': 'METADATA', 'SRS_ID': 'SRS_ID', 'KDBBPS': 'KDBBPS', 'KDCBPS': 'KDCBPS', 'KDCPUM': 'KDCPUM', 'KDEBPS': 'KDEBPS', 'KDEPUM': 'KDEPUM', 'KDPBPS': 'KDPBPS', 'KDPKAB': 'KDPKAB', 'KDPPUM': 'KDPPUM', 'LUASWH': 'LUASWH', 'TIPADM': 'TIPADM', 'WADMKC': 'WADMKC', 'WADMKD': 'WADMKD', 'WADMKK': 'WADMKK', 'WADMPR': 'WADMPR', 'WIADKC': 'WIADKC', 'WIADKK': 'WIADKK', 'WIADPR': 'WIADPR', 'WIADKD': 'WIADKD', 'UUPP': 'UUPP', 'luas': 'luas', 'SHAPE_Leng': 'SHAPE_Leng', 'SHAPE_Area': 'SHAPE_Area', });
...
lyr_balai_desa_20.set('fieldAliases', {'id': 'id', 'nama': 'nama', });
lyr_kantor_kecamatan_21.set('fieldAliases', {'id': 'id', 'nama': 'nama', });
lyr_pendidikan_22.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'desa': 'desa', });
lyr_kesehatan_23.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'desa': 'desa', });
lyr_wisata_24.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'desa': 'desa', });
lyr_tempat_ibadah_25.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'desa': 'desa', });
lyr_Kuburan_26.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'Alamat': 'Alamat', 'desa': 'desa', });
lyr_Lapangan_27.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'desa': 'desa', });
lyr_Toko_28.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'Desa': 'Desa', });
lyr_Tempatmakan_29.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'Desa': 'Desa', });
lyr_Rumah_saya_30.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'Alamat': 'Alamat', });
lyr_batas_kecamatan_1.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'METADATA': 'TextEdit', 'SRS_ID': 'TextEdit', 'KDBBPS': 'TextEdit', 'KDCBPS': 'TextEdit', 'KDCPUM': 'TextEdit', 'KDEBPS': 'TextEdit', 'KDEPUM': 'TextEdit', 'KDPBPS': 'TextEdit', 'KDPKAB': 'TextEdit', 'KDPPUM': 'TextEdit', 'LUASWH': 'TextEdit', 'TIPADM': 'Range', 'WADMKC': 'TextEdit', 'WADMKD': 'TextEdit', 'WADMKK': 'TextEdit', 'WADMPR': 'TextEdit', 'WIADKC': 'TextEdit', 'WIADKK': 'TextEdit', 'WIADPR': 'TextEdit', 'WIADKD': 'TextEdit', 'UUPP': 'TextEdit', 'luas': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', });
lyr_batas_desa_2.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'METADATA': 'TextEdit', 'SRS_ID': 'TextEdit', 'KDBBPS': 'TextEdit', 'KDCBPS': 'TextEdit', 'KDCPUM': 'TextEdit', 'KDEBPS': 'TextEdit', 'KDEPUM': 'TextEdit', 'KDPBPS': 'TextEdit', 'KDPKAB': 'TextEdit', 'KDPPUM': 'TextEdit', 'LUASWH': 'TextEdit', 'TIPADM': 'Range', 'WADMKC': 'TextEdit', 'WADMKD': 'TextEdit', 'WADMKK': 'TextEdit', 'WADMPR': 'TextEdit', 'WIADKC': 'TextEdit', 'WIADKK': 'TextEdit', 'WIADPR': 'TextEdit', 'WIADKD': 'TextEdit', 'UUPP': 'TextEdit', 'luas': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', });
...
lyr_balai_desa_20.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', });
lyr_kantor_kecamatan_21.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', });
lyr_pendidikan_22.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'desa': 'TextEdit', });
lyr_kesehatan_23.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'desa': 'TextEdit', });
lyr_wisata_24.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'desa': 'TextEdit', });
lyr_tempat_ibadah_25.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'desa': 'TextEdit', });
lyr_Kuburan_26.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'Alamat': 'TextEdit', 'desa': 'TextEdit', });
lyr_Lapangan_27.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'desa': 'TextEdit', });
lyr_Toko_28.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'Desa': 'TextEdit', });
lyr_Tempatmakan_29.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'Desa': 'TextEdit', });
lyr_Rumah_saya_30.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'Alamat': 'TextEdit', });
lyr_batas_kecamatan_1.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'no label', 'REMARK': 'no label', 'METADATA': 'no label', 'SRS_ID': 'no label', 'KDBBPS': 'no label', 'KDCBPS': 'no label', 'KDCPUM': 'no label', 'KDEBPS': 'no label', 'KDEPUM': 'no label', 'KDPBPS': 'no label', 'KDPKAB': 'no label', 'KDPPUM': 'no label', 'LUASWH': 'no label', 'TIPADM': 'no label', 'WADMKC': 'no label', 'WADMKD': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'WIADKC': 'no label', 'WIADKK': 'no label', 'WIADPR': 'no label', 'WIADKD': 'no label', 'UUPP': 'no label', 'luas': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
lyr_batas_desa_2.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'no label', 'REMARK': 'no label', 'METADATA': 'no label', 'SRS_ID': 'no label', 'KDBBPS': 'no label', 'KDCBPS': 'no label', 'KDCPUM': 'no label', 'KDEBPS': 'no label', 'KDEPUM': 'no label', 'KDPBPS': 'no label', 'KDPKAB': 'no label', 'KDPPUM': 'no label', 'LUASWH': 'no label', 'TIPADM': 'no label', 'WADMKC': 'no label', 'WADMKD': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'WIADKC': 'no label', 'WIADKK': 'no label', 'WIADPR': 'no label', 'WIADKD': 'no label', 'UUPP': 'no label', 'luas': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
...
lyr_desa_besuki_16.set('fieldLabels', {'NAMOBJ': 'header label - always visible', 'FCODE': 'no label', 'REMARK': 'no label', 'METADATA': 'no label', 'SRS_ID': 'no label', 'KDBBPS': 'no label', 'KDCBPS': 'no label', 'KDCPUM': 'no label', 'KDEBPS': 'no label', 'KDEPUM': 'no label', 'KDPBPS': 'no label', 'KDPKAB': 'no label', 'KDPPUM': 'no label', 'LUASWH': 'no label', 'TIPADM': 'no label', 'WADMKC': 'no label', 'WADMKD': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'WIADKC': 'no label', 'WIADKK': 'no label', 'WIADPR': 'no label', 'WIADKD': 'no label', 'UUPP': 'no label', 'luas': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
...
lyr_balai_desa_20.set('fieldLabels', {'id': 'no label', 'nama': 'no label', });
lyr_kantor_kecamatan_21.set('fieldLabels', {'id': 'no label', 'nama': 'no label', });
lyr_pendidikan_22.set('fieldLabels', {'id': 'no label', 'nama': 'no label', 'desa': 'no label', });
lyr_kesehatan_23.set('fieldLabels', {'id': 'no label', 'nama': 'no label', 'desa': 'no label', });
lyr_wisata_24.set('fieldLabels', {'id': 'no label', 'nama': 'no label', 'desa': 'no label', });
lyr_tempat_ibadah_25.set('fieldLabels', {'id': 'no label', 'nama': 'no label', 'desa': 'no label', });
lyr_Kuburan_26.set('fieldLabels', {'id': 'no label', 'Nama': 'no label', 'Alamat': 'no label', 'desa': 'no label', });
lyr_Lapangan_27.set('fieldLabels', {'id': 'no label', 'Nama': 'no label', 'desa': 'no label', });
lyr_Toko_28.set('fieldLabels', {'id': 'no label', 'Nama': 'no label', 'Desa': 'no label', });
lyr_Tempatmakan_29.set('fieldLabels', {'id': 'no label', 'Nama': 'no label', 'Desa': 'no label', });
lyr_Rumah_saya_30.set('fieldLabels', {'id': 'no label', 'Nama': 'inline label - always visible', 'Alamat': 'no label', });
lyr_Rumah_saya_30.on('precompose', function(evt) {
