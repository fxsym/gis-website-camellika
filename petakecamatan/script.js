// Global variable to store map layers
        ...
        // Fungsi untuk membuat teks pencarian dengan semua variasi case
        ...
        function getFeatureDisplayName(featureData) {
            ...
            const nameFields = ['Nama', 'nama', 'NAMA', 'name', 'NAME', 'Jenis', 'jenis'];
            for (let field of nameFields) {
                if (props[field]) {
                    return props[field];
                }
            }
            const otherFields = ['Jenjang', 'jenjang', 'Alamat', 'alamat', 'Keterangan', 'keterangan', 'Desa', 'desa'];
        ...
        console.log('✅ Enhanced Layer Search with Feature Zoom loaded!');
        ...
        // Mobile dropdown toggle - PERBAIKAN
        if (dropdownToggle) {
            // Hanya handle klik pada nav-link, bukan seluruh dropdownToggle
